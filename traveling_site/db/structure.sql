...
--
-- Name: socailusers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.socailusers (
    id bigint NOT NULL,
...
--
-- Name: socailusers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.socailusers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: socailusers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.socailusers_id_seq OWNED BY public.socailusers.id;
...
--
-- Name: socailusers id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socailusers ALTER COLUMN id SET DEFAULT nextval('public.socailusers_id_seq'::regclass);
...
--
-- Name: socailusers socailusers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.socailusers
    ADD CONSTRAINT socailusers_pkey PRIMARY KEY (id);
